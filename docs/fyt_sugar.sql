...
CREATE TABLE `sys_authority` (
  ...
  `AdminId` bigint(20) DEFAULT NULL COMMENT '管理员编号',
  `MenuId` bigint(20) DEFAULT NULL COMMENT '菜单编号',
...
CREATE TABLE `sys_code` (
  ...
  `UpdateUser` varchar(20) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典信息表';
...
CREATE TABLE `sys_codetype` (
  ...
  `ParentIdList` varchar(500) DEFAULT NULL,
  ...
  `UpdateUser` varchar(20) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典分类信息';
...
CREATE TABLE `sys_log` (
  ...
  `ReturnValue` longtext COMMENT '返回结果',
...
CREATE TABLE `sys_role` (
  ...
  `ParentId` bigint(20) DEFAULT NULL COMMENT '角色父节点',
