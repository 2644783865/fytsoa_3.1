...
CREATE TABLE `sys_admin` (
  ...
  `RoleGroup` varchar(200) NOT NULL COMMENT '所属角色',
  `PostGroup` varchar(200) NOT NULL COMMENT '所属岗位',
  `OrganizeId` bigint(25) NOT NULL COMMENT '所属部门',
  `OrganizeIdList` varchar(200) DEFAULT NULL COMMENT '所属上级部门组',
  `LoginAccount` varchar(30) NOT NULL COMMENT '登录账号',
  `LoginPassWord` varchar(200) NOT NULL COMMENT '登录密码',
  ...
  `Summary` varchar(200) DEFAULT NULL COMMENT '备注',
  ...
  `UpLoginTime` datetime DEFAULT NULL COMMENT '上次登录时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_admin` VALUES (1260380358965334016, '1251126367240720384', '1251019168074043392', 1248158071138684928, '1247889786656657408,1248157435479330816,1248158071138684928', 'admins', '1234567', NULL, '李四', '13511111111', '222@qq.com', '男', b'1', b'0', '111111111', '2020-05-13 09:24:29', 'admin', NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_admin` VALUES (1260394904224403456, '1251126367240720384', '1250983438480183296,1251019168074043392', 1247889786656657408, '1247889786656657408', 'adminsss', '123456', NULL, 'wangwu', '2132131313', NULL, '男', b'1', b'1', NULL, '2020-05-13 10:22:17', 'admin', NULL, NULL, NULL, NULL, 0);
COMMIT;
...
CREATE TABLE `sys_authority` (
  ...
  `AdminId` bigint(25) DEFAULT NULL COMMENT '管理员编号',
  `MenuId` bigint(25) DEFAULT NULL COMMENT '菜单编号',
  `BtnFun` varchar(500) DEFAULT NULL COMMENT '按钮功能组',
...
CREATE TABLE `sys_code` (
  `Id` bigint(25) NOT NULL COMMENT '唯一编号',
  `TypeId` bigint(25) NOT NULL COMMENT '分类编号',
  `Name` varchar(50) NOT NULL COMMENT '字典值名称',
  `CodeValues` varchar(50) DEFAULT NULL COMMENT '字典值阈值',
  ...
  `UpdateUser` varchar(20) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='字典信息表';
...
INSERT INTO `sys_code` VALUES (1260488544808472576, 1258647245457330176, '111', '222', 1, b'1', b'1', NULL, '2020-05-13 16:34:22', 'admin', NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_codetype` (
  `Id` bigint(25) NOT NULL COMMENT '唯一编号',
  `ParentId` bigint(32) NOT NULL COMMENT '父节点',
  ...
  `UpdateUser` varchar(20) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='字典分类信息';

-- ----------------------------
-- Records of sys_codetype
-- ----------------------------
BEGIN;
INSERT INTO `sys_codetype` VALUES (1258634388292374528, 0, 1, '商品规格', 1, b'0', b'0', '2020-05-08 13:46:37', 'admin', NULL, NULL);
INSERT INTO `sys_codetype` VALUES (1258640122090491904, 1258634388292374528, 2, '品牌', 1, b'0', b'0', '2020-05-08 14:09:24', 'admin', NULL, NULL);
INSERT INTO `sys_codetype` VALUES (1258647106323877888, 1258634388292374528, 2, '季节', 1, b'0', b'0', '2020-05-08 14:37:09', 'admin', NULL, NULL);
INSERT INTO `sys_codetype` VALUES (1258647173655040000, 0, 1, '系统权限', 1, b'1', b'0', '2020-05-08 14:37:25', 'admin', NULL, NULL);
INSERT INTO `sys_codetype` VALUES (1258647245457330176, 1258647173655040000, 2, '按钮功能', 1, b'1', b'0', '2020-05-08 14:37:43', 'admin', NULL, NULL);
INSERT INTO `sys_codetype` VALUES (1258652724044632064, 1258634388292374528, 2, '1111', 1, b'0', b'1', '2020-05-08 14:59:29', 'admin', NULL, NULL);
INSERT INTO `sys_codetype` VALUES (1258675395226636288, 0, 1, '测试', 1, b'0', b'1', '2020-05-08 16:29:34', 'admin', NULL, NULL);
INSERT INTO `sys_codetype` VALUES (1258675415686451200, 1258675395226636288, 2, 'aaa', 1, b'0', b'1', '2020-05-08 16:29:39', 'admin', NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_log` (
  ...
  `OperateType` varchar(20) DEFAULT NULL COMMENT '操作类型:例如添加、修改',
  `Method` varchar(10) DEFAULT NULL COMMENT '提交类型：get/post/delete',
  `OperateUser` varchar(30) DEFAULT NULL COMMENT '操作人',
  `IP` varchar(20) DEFAULT NULL COMMENT 'IP',
  `Address` varchar(50) DEFAULT NULL COMMENT '操作地址',
...
CREATE TABLE `sys_menu` (
  ...
  `ParentId` bigint(25) DEFAULT NULL COMMENT '父节点',
  `ParentIdList` varchar(200) DEFAULT NULL COMMENT '父节点集合组',
  `Code` varchar(30) DEFAULT NULL COMMENT '权限标识',
  `Layer` int(11) NOT NULL DEFAULT '0' COMMENT '菜单层级',
  `Urls` varchar(100) DEFAULT NULL COMMENT '路由地址',
  `Icon` varchar(50) DEFAULT NULL COMMENT '菜单图标',
  `Sort` int(11) NOT NULL DEFAULT '1' COMMENT '排序',
  `Status` bit(1) NOT NULL DEFAULT b'1' COMMENT '状态',
  `IsDel` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `Types` int(11) NOT NULL DEFAULT '1' COMMENT '菜单类型：1=目录  2=菜单',
  `BtnFun` varchar(1000) DEFAULT NULL COMMENT '菜单按钮',
  `CreateTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUser` varchar(20) DEFAULT NULL COMMENT '创建人',
  `UpdateTime` datetime DEFAULT NULL COMMENT '修改时间',
  `UpdateUser` varchar(20) DEFAULT NULL COMMENT '修改人',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` VALUES (1258686437235232768, '系统管理', 0, NULL, 'Sys', 1, NULL, 'el-icon-orange', 1, b'1', b'0', 1, 'null', '2020-05-08 17:13:27', 'admin', NULL, NULL);
INSERT INTO `sys_menu` VALUES (1258687635354947584, '部门管理', 1258686437235232768, '1258686437235232768,1258687635354947584', 'SysOrganize', 2, 'sys/organize', NULL, 4, b'1', b'0', 2, 'null', '2020-05-08 17:18:12', 'admin', NULL, NULL);
INSERT INTO `sys_menu` VALUES (1260452590072762368, '角色管理', 1258686437235232768, '1258686437235232768,1260452590072762368', 'SysRole', 2, '/sys/role', NULL, 5, b'1', b'0', 2, '[{\"id\":\"1258675680309284864\",\"name\":\"添加\",\"value\":\"Add\"},{\"id\":\"1258675708239155200\",\"name\":\"修改\",\"value\":\"Modify\"},{\"id\":\"1258676199962578944\",\"name\":\"删除\",\"value\":\"Delete\"}]', '2020-05-13 14:11:30', 'admin', NULL, NULL);
INSERT INTO `sys_menu` VALUES (1260452731953483776, '岗位管理', 1258686437235232768, '1258686437235232768,1260452731953483776', 'SysPost', 2, '/sys/post', NULL, 6, b'1', b'0', 2, '[{\"id\":\"1258675680309284864\",\"name\":\"添加\",\"value\":\"Add\"},{\"id\":\"1258675708239155200\",\"name\":\"修改\",\"value\":\"Modify\"},{\"id\":\"1258676199962578944\",\"name\":\"删除\",\"value\":\"Delete\"}]', '2020-05-13 14:12:04', 'admin', NULL, NULL);
INSERT INTO `sys_menu` VALUES (1260452840476905472, '用户管理', 1258686437235232768, '1258686437235232768,1260452840476905472', 'SysUser', 2, '/sys/user', NULL, 7, b'1', b'0', 2, '[{\"id\":\"1258675680309284864\",\"name\":\"添加\",\"value\":\"Add\"},{\"id\":\"1258675708239155200\",\"name\":\"修改\",\"value\":\"Modify\"},{\"id\":\"1258676199962578944\",\"name\":\"删除\",\"value\":\"Delete\"}]', '2020-05-13 14:12:30', 'admin', NULL, NULL);
INSERT INTO `sys_menu` VALUES (1260452945938485248, '菜单管理', 1258686437235232768, '1258686437235232768,1260452945938485248', 'SysMenu', 2, '/sys/menu', NULL, 8, b'1', b'0', 2, '[{\"id\":\"1258675680309284864\",\"name\":\"添加\",\"value\":\"Add\"},{\"id\":\"1258675708239155200\",\"name\":\"修改\",\"value\":\"Modify\"},{\"id\":\"1258676199962578944\",\"name\":\"删除\",\"value\":\"Delete\"},{\"id\":\"1258676306619535360\",\"name\":\"审核\",\"value\":\"Audit\"}]', '2020-05-13 14:12:55', 'admin', NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (1339869568155389952, '工作台', 1339869098296872960, '1339869098296872960,1339869568155389952,', 'Workbench', 2, 'home/workbench', NULL, 1, b'1', b'0', 2, '[]', '2020-12-18 17:46:13', NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (1339869712040988672, '数据中心', 1339869098296872960, '1339869098296872960,1339869712040988672,', 'DataCenter', 2, 'home/data', NULL, 1, b'1', b'0', 2, '[]', '2020-12-18 17:46:13', NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (1339870114027278336, '日志管理', 1258686437235232768, '1339870114027278336,', 'Logs', 2, 'sys/logs', NULL, 1, b'1', b'0', 2, '[]', '2020-12-18 17:46:13', NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_organize` (
  ...
  `Number` varchar(30) DEFAULT NULL COMMENT '机构编码',
  `ParentIdList` varchar(500) DEFAULT NULL COMMENT '父节点集合',
  `Layer` int(11) NOT NULL DEFAULT '0' COMMENT '部门层级',
  `Sort` int(11) NOT NULL DEFAULT '1' COMMENT '排序',
  `Status` bit(1) NOT NULL DEFAULT b'1' COMMENT '状态',
  `IsDel` bit(1) NOT NULL DEFAULT b'0' COMMENT '删除状态',
  `LeaderUser` varchar(20) DEFAULT NULL COMMENT '部门负责人',
  `LeaderMobile` varchar(20) DEFAULT NULL COMMENT '联系电话',
  `LeaderEmail` varchar(50) DEFAULT NULL COMMENT '联系邮箱',
  `CreateTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUser` varchar(20) DEFAULT NULL COMMENT '创建人',
  `UpdateTime` datetime DEFAULT NULL COMMENT '修改时间',
  `UpdateUser` varchar(20) DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `sys_post` (
  ...
  `Number` varchar(6) DEFAULT NULL COMMENT '岗位编码',
  `Sort` int(11) NOT NULL DEFAULT '1' COMMENT '排序',
  `Status` bit(1) NOT NULL DEFAULT b'1' COMMENT '岗位状态',
  `IsDel` bit(1) NOT NULL DEFAULT b'0' COMMENT '删除状态',
  `Summary` varchar(500) DEFAULT NULL COMMENT '备注信息',
  `CreateTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUser` varchar(20) DEFAULT NULL COMMENT '创建人',
  `UpdateTime` datetime DEFAULT NULL COMMENT '修改时间',
  `UpdateUser` varchar(20) DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `sys_role` (
  ...
  `ParentId` bigint(25) DEFAULT NULL COMMENT '角色父节点',
  `ParentIdList` varchar(500) DEFAULT NULL COMMENT '父节点结合',
  `Layer` int(11) NOT NULL DEFAULT '1' COMMENT '角色层级',
  `Number` varchar(6) DEFAULT NULL COMMENT '角色编号',
  ...
  `CreateUser` varchar(20) DEFAULT NULL COMMENT '创建人',
  `UpdateTime` datetime DEFAULT NULL COMMENT '修改时间',
  `UpdateUser` char(10) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
