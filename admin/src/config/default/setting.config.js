...
module.exports = {
  ...
  systemName: 'FytSoa Admin',         //系统名称
  copyright: '2020 FytSoa 飞易腾科技',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    { link: 'http://www.feiyit.com', name: 'Home' },
    { link: 'https://gitee.com/feiyit', icon: 'github' },
    { link: 'http://www.feiyit.com', name: 'FytSoa' }
  ],
}
