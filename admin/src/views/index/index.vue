        ...
        <el-card>
          ...
          <div>
            <ul>
              ...
              <li>
                开源地址
                <a target="_blank" href="https://github.com/feiyit/fytsoa_3.1">
                  如果有幸帮到了你，麻烦给个star
                </a>
              </li>
              <li>提供讨论群专属文档，QQ群 1060012125</li>
            </ul>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card>
          ...
          <div>
            <ul>
              <li>
                演示地址：
                <a target="_blank" href="http://fytsugar.feiyit.com/">点我</a>
              </li>
              <li>PRO独立版本与开源版本不同</li>
              <li>
                无版权限制，无需额外配置，拿来即用，支持权限精确到权限点，按钮级权限取反，支持代码一键生成
              </li>
              <li>免费加入fyt-sugar github团队</li>
              <li>提供25种布局主题搭配</li>
              <li>图标使用方式大为简化</li>
